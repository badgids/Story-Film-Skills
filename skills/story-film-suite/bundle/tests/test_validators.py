...
class Tests(unittest.TestCase):
    ...
    def test_version_format_and_next(self):
        ...
        self.assertEqual(version, '00.00.36')
        self.assertEqual(version_display.display_version(version), 'v0.0.36')
        ...
        subprocess.run([sys.executable, str(ROOT / 'scripts/bump_version.py'), '--check-next', '00.00.37'], check=True)
