...
def main() -> int:
    ...
    required = [
        ...
        'skills/generation-workflow-setup/SKILL.md',
        'skills/llm-model-lifecycle/SKILL.md',
        ...
        'scripts/llm_model_lifecycle.py',
        ...
        'comfyui_workflows/video/MiniMax-H3/video_minimax_h3_r2v_exact_audio_hybrid.json',
        'comfyui_workflows/character-sheet/MiniMax-H3/CharacterTurnaroundSheetH3.json',
        'comfyui_workflows/location-orbit/MiniMax-H3/LocationOrbitSheetH3.json',
        'comfyui_workflows/prop-sheet/MiniMax-H3/PropReferenceSheetH3.json',
        'comfyui_workflows/image/Krea2/Krea2_txt2img.json',
        'comfyui_workflows/image/Qwen-Image-2512/image_qwen_Image_2512.json',
        'comfyui_workflows/llm/Qwen3/llm_qwen3_text_gen.json',
